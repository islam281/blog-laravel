            ...
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item submenu dropdown @yield('active-category')">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="nav-item @yield('active-category')" ><a class="nav-link" href="{{route('theme.category',['id'=>$category->id])}}">{{$category->name}}</a></li>
                    @endforeach
                ...
                <li class="nav-item submenu dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <form action="{{route('logout')}}" method="post" id="logout">
                          @csrf
                          <li class="nav-item"><a class="nav-link"  href="javascript:$('form#logout').submit();">logout</a></li>
